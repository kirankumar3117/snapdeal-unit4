...
footware.textContent = "Kid's Products";
...
var content_1 = document.createTextNode("Kid's Clothing");

content_1.addEventListener("click",function(){
    window.location.href="kids_clothing.html"
})
//content_1.style.color = "black"
var content_2 = document.createTextNode("Kid's Toys");
